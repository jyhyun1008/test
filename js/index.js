...
function parseMd(md){
    ...
    md = md.replace(/\n\[(.+)\]\n\n[\*]{2}([^\*]+)[\*]{2}\n\n[\@]{1}([^\s]+)/g, '<div class="account_wrapper"><img src="img/$1.png" class="header_image"></img><img src="img/$3.png" class="profile_image"></img><div class="user"><div class="username">$2</div><div class="userid">@$3</div><a href="/index.html?p=account/$1"><div class="button">팔로우</div></a></div>');
