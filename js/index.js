...
function parseMd(md){
    ...
    md = md.replace(/\n[\@]{1}([^\s]+)\s(.+)\n\n(.+)\n\n\[follow\]/g, '<div class="tweet_wrapper"><a href="?p=account/$1"><img src="img/$1.png" class="profile_image"></img></a><div class="user"><div class="username">$2</div><div class="userid">@$1</div><div class="user_bio">$3</div></div><a href="index.html?p=account/$1"><div class="button">팔로우</div></a></div>');
